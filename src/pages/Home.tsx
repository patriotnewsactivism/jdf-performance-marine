        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Hudson Valley's
              <span className="text-primary block animate-in slide-in-from-left duration-1000 delay-300">Performance Marine</span>
              Experts
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-700">
              <Button asChild size="lg" className="text-lg shadow-glow-orange hover:shadow-xl transition-all hover:scale-105">
                <a href="tel:845-787-4241">
                  <Phone className="w-5 h-5 mr-2" />
                  Call Now: 845-787-4241
                </a>
              </Button>
              <Button asChild variant="secondary" size="lg" className="text-lg shadow-lg hover:shadow-glow-blue hover:scale-105 transition-all">
                <Link to="/services">
                  View Services
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            {popularServices.map((service, index) => (
              <Card key={index} className="p-6 hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30">
          ...
          <div className="text-center">
            <Button asChild size="lg" variant="outline" className="hover:shadow-glow-blue transition-all hover:scale-105">
              <Link to="/services">
                View All Services
                <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
